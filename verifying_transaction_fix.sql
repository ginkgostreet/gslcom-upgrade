  ...
  * This code was borrowed from "http://wiki.civicrm.org/confluence/display/CRMDOC/Fixing+Transactions+Missing+a+Payment+Instrument+-+4.4.3+Upgrades"
  * Please read the CiviWiki to understand exactly what the script below is doing 
  * Beginning of script
  */
